...
INSERT INTO "new_calls" ("answeredAt", "connectedTime", "contactId", "createdAt", "direction", "duration", "endTime", "endedAt", "externalId", "fromNumber", "id", "managerId", "mangoCallId", "phone", "recordingUrl", "result", "startTime", "status", "toNumber") SELECT "answeredAt", "connectedTime", "contactId", "createdAt", "direction", "duration", "endTime", "endedAt", "externalId", "fromNumber", "id", "managerId", "mangoCallId", "phone", "recordingUrl", "result", "startTime", "status", "toNumber" FROM "calls";
DROP TABLE "calls";
